...
<div>
  ...
  <div align=center>
      <a href="https://git.io/typing-svg"><img src="https://readme-typing-svg.demolab.com/?font=VT323&size=35&duration=3500&pause=300&color=6A0572&center=true&vCenter=true&width=500&lines=Hey%2C+I+am+Blightjoint;Welcome+to+My+GitHub+Profile;Inquisitive+and+Curious+by+nature;Software+Engineer;Backend+and+Frontend+Developer;Football+Lover;Gym+Guy;Music+and+Programming+Lover" alt="Typing SVG" /></a>
  </div>
</div>
 ...
 *
 * @constructor
 * @param {string} location - Rowlett, Texas.
 * @param {string} languagues - English.
 * @param {string} jobTitle - Programmer.
 * @param {string} specialization - Um....
 * @param {string} interests - AI, Coding.
 * @param {string} hobbies - Gaming, Skateboarding, more coding.
 * @param {string} education - Homeschooled, MYTEKLAB.
 * @param {string} approachable - Maybe, dpends on what it is, don't hesitate to react out.
 * @param {string} stength - *snif*.
 * @param {string} weakness - I can not make sence sometimes.
 *
...
<details>
  <summary>A Joke</summary>
  <br>
  <small><i>Why did the scarecrow win an award? Because he was outstanding in his field!</i></small>
  <br>
...
If you have any questions about web development, my engine or anything else, feel free to <a href="mailto:eesa@eesasharma.com">contact me by email</a>, I won't bite, I promise.
...
<div align=center>
 <a href="https://www.linkedin.com/in/EesaSharma/" target="_blank"><img src="https://img.shields.io/static/v1?style=for-the-badge&message=LinkedIn&color=0A66C2&logo=LinkedIn&logoColor=FFFFFF&label=" alt="LinkedIn" /></a>
